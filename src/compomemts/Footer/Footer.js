...
const Footer = () =>{
    return(
<div>
  <h1 className="db fw6 lh-copy f6"> find more on </h1>
<footer class="pv4 ph3 ph5-ns tc">
  <a class="link near-black hover-silver dib h2 w2 mr3" href="https://github.com" title="GitHub">
  ...
  <a class="link hover-silver near-black dib h2 w2 mr3" href="https://stackoverflow.com/" title="Stack Overflow">
    <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill-rule="evenodd" 
    clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
